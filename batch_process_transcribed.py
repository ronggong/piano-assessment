...
from parser.txt_parser import sv_score_transcribed_parser
...
if __name__ == "__main__":
        ...
        if '.DS_Store' not in folder:
            ...
            for filename in filenames_transcribed:
                ...
                if filename.endswith('.mp3.midi.txt'):
                    ...
                    list_score_student_transcribed, list_annotation = sv_score_transcribed_parser(filename_student_transcribed)
    ...
    with open("./data/list_annotation_transcribed.pkl", "wb") as f:
