        ...
        if '.DS_Store' not in folder:
            ...
            for filename in filenames_annotation:
                if filename.endswith('.txt'): # annotation file name ends with .txt
                    ...
                    # TODO: parse annotation and manual alignment, write an annotation parser
                    list_annotation, list_score_aligned = sv_score_annotation_parser_manual_aligned(filename_student_annotation)

                    # TODO: implement features_student_manual_alignment, extract student performance features
                    list_features_student = features_student_manual_alignment(list_score_aligned ,filename_student_annotation)
